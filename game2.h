...
#define Null -500
#define recursivLevelRabbit 2
#define recursivLevelWolves 6
...
public:
		...
		void playWithThemselves(int & i, int & j, int & flag);
	...
	private:
		...
		//алгоритм минимакса
		int runMinMax(MonsterType monster, int recursivLevel, int maxRecursivLevel, int alpha, int beta);
